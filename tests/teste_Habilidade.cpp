...
TEST_CASE("Teste 01: Testando a inicializacao e atributos de Habilidade"){
    Habilidade habilidade_teste("habilidade_teste", false, 30, false, Efeito("Sem_efeito", 0, 0), 0);
...
TEST_CASE("Teste 02: Testando a funcao calcularImpacto em Habilidade"){
    Habilidade habilidade_teste("Bola de Fogo", false, 50, true, Efeito("Queimadura", 5, 2), 0);
